...
ActiveRecord::Schema[8.0].define(version: 2025_08_18_060908) do
  ...
  create_table "boiler_calculations", force: :cascade do |t|
    ...
    t.index ["created_by_id"], name: "index_boiler_calculations_on_created_by_id"
    t.index ["lead_id"], name: "index_boiler_calculations_on_lead_id"
  end
  ...
  create_table "commissions", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["lead_id"], name: "index_commissions_on_lead_id"
  end
  ...
  create_table "installation_notes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["lead_id"], name: "index_installation_notes_on_lead_id"
  end
  ...
  create_table "measurements", force: :cascade do |t|
    ...
    t.decimal "volume"
    t.text "notes"
    t.integer "measured_by_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["lead_id"], name: "index_measurements_on_lead_id"
